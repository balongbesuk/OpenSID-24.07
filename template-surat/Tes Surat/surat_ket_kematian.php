						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-3 col-lg-2">
										<div class="input-group input-group-sm date">
											...
											<input title="Pilih Tanggal" class="form-control input-sm required " name="tanggal_mati" type="text" value="<?= $log_penduduk['tgl_peristiwa'] ?>"/>
										</div>
									</div>
									<div class="col-sm-2">
										<div class="input-group input-group-sm date">
											...
											<input class="form-control input-sm required" name="jam" id="jammenit_1" type="text" value="<?= $log_penduduk['jam_mati'] ?>"/>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="tempat_mati" class="form-control input-sm required" placeholder="Tempat Meninggal" value="<?= $log_penduduk['meninggal_di'] ?>"></input>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<select class="form-control input-sm" name="penolong_mati">
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<input type="text" name="anakke" class="form-control input-sm data_lahir required" placeholder="Anak Ke" value="<?= $log_penduduk['anak_ke']?>" ></input>
									</div>
								</div>
								<!-- AYAH -->
								<?php if ($ayah): ?>
								...
								<div class="form-group">
										<label class="col-sm-3 control-label">No Telpon / Email</label>
										<div class="col-sm-8">
											<input class="form-control input-sm required" type="text" name="lokasi_disdukcapil" id="lokasi_disdukcapil" placeholder="No Telepon / E-Mail" value="<?= $_SESSION['post']['lokasi_disdukcapil']?>">
										</div>
									</div>
