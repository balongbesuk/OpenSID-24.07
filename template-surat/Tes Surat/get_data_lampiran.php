<?php defined('BASEPATH') || exit('No direct script access allowed');
	...
	if ($ibu)
	{
		...
		$input['tempat_lahir_ibu']		    = $ibu['tempatlahir'];
	...
	if ($ayah)
	{
	    $input['no_kk'] 	                = $ayah['no_kk'];
		$input['nik_ayah']                  = $ayah['nik'];
		$input['nama_ayah']                 = $ayah['nama'];
		$input['tempat_lahir_ayah'] 		= $ayah['tempatlahir'];
	...
	if ($input['id_pelapor'])
	{
		...
		$input['kk_pelapor'] 	            = $pelapor['no_kk'];
